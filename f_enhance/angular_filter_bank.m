%----------------------------------------------------------
%angular_filter_bank:  precomputes angular filter bank and also generates a C header file with filter coefficients. The matlab variable
%angf is stored in file 'angular_filters.mat' and the C variables are stored in 'angular_fiter.h'.
%There are TSTEPS number of raised cosine filter that span the interval [0,180] usage
...
%angular_distance computes angular distance-acute angle 
