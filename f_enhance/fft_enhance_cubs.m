%fft_enhance_cubs: enhances the fingerprint image
...
%raised_cosine: returns 1D spectral window
...
%raised_cosine_window: returns 2D spectral window
...
%get_angular_filter: generates an angular filter centered around 'th' and with bandwidth 'bw'
...
%get_angular_bw_image: the bandwidth allocation is currently based on heuristics
